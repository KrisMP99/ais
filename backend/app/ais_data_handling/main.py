...
parser.add_argument("--specific", help="Download, cleanse and insert a specific AIS-file and insert it. Example: 'aisdk-2022-01-01.zip'",required=False, default=None)
parser.add_argument("--interval", help="Download, cleanse and insert AIS-data in the interval given. Format: YYYY-MM-DD::YYY-MM-DD", required=False, default=None)
